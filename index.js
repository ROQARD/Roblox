    ...
    if (url.pathname.startsWith("/api/")) {
      ...
      const tryFetch = async (s, e) => {
        for (let p of PROXIES) {
          try {
            const r = await fetch(`https://${s}.${p}${e}`, { headers: { "User-Agent": "RoStats_Fixed" }});
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Inter', sans-serif; }
        ...
        .btn { text-decoration: none; text-align: center; padding: 18px; border-radius: 18px; font-weight: 800; text-transform: uppercase; font-size: 0.85rem; cursor: pointer; border: none; }
...
<body>
    <div class="container">
        <div class="search-area">
            ...
            <div class="input-box">
                <input type="text" id="placeId" placeholder="ID Here...">
        ...
        <div id="results" class="dashboard">
            <div class="box"><h2 id="gTitle" style="font-size: 1.8rem;">-</h2><a id="gOwner" style="color:var(--accent); text-decoration:none; font-size:0.95rem; font-weight:600; margin-top:8px; display:inline-block;" target="_blank">-</a></div>
            ...
            <div class="content-card">
                <div class="date-row"><span><b>Created:</b> <span id="dCreate" style="color:#fff"></span></span><span><b>Updated:</b> <span id="dUpdate" style="color:#fff"></span></span></div>
                <div class="label" style="margin-bottom:10px;">Description</div><div id="gDesc" class="full-desc"></div>
            </div>
            <div class="action-grid"><button class="btn copy-btn" onclick="copyStats()">Copy Summary</button><a id="robloxLink" class="btn play-btn" target="_blank">Open Roblox</a></div>
        </div>
    </div>
    ...
    <script>
        ...
        async function update() {
            ...
            try {
                ...
                const g = d.game; const up = d.votes.upVotes || 0; const down = d.votes.downVotes || 0;
        ...
        function copyStats() {
            ...
            const v = document.getElementById('vVisit').innerText;
